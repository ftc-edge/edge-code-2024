...
## Getting Started
To use this repository template, you can clone this template repository to your own github repositories. There are many ways to do it but I am going to describe one way which is using GitHub Desktop. If you are more familiar with other similar tools, feel free to use it instead.
* On a web browser, enter the URL https://github.com/trc492/FtcTemplate.
* Then, click the big green "Use this template" button near the upper right corner of the web page and answer the questions on where you want to clone this repository to your GitHub repositories.
* Once the clone is done. Clone your GitHub repository to your computer using your favorite GitHub tool such as GitHub Desktop.
