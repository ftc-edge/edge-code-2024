...
public class AutoBlueFront extends LinearOpMode {
    BluePropPipelineFar propPipeline;
    OpenCvCamera camera;
    double route;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        propPipeline = new BluePropPipelineFar(telemetry);
        ...
        TrajectorySequence traj2 = drive.trajectorySequenceBuilder(startPose)
                .splineToLinearHeading(new Pose2d(-40.00, 28.00,Math.toRadians(270)),Math.toRadians(270))
                .build();
        ...
        AutoBlueFront.State currentState = AutoBlueFront.State.IDLE;

        route = propPipeline.getLocation();

        if (route == 1) {
            currentState = AutoBlueFront.State.TRAJECTORY_1;
            cycleStart = traj1c.end();
        } else if (route == 2) {
            currentState = AutoBlueFront.State.TRAJECTORY_2;
            cycleStart = traj2c.end();
        } else if (route == 3) {
            currentState = AutoBlueFront.State.TRAJECTORY_3;
            ...
            switch (currentState) {
                case TRAJECTORY_1:
                    ...
                    if (!drive.isBusy()) {
                        ...
                        currentState = AutoBlueFront.State.TRAJECTORY_1C;
                    }
                    break;
                ...
                case TRAJECTORY_2:
                    ...
                    if (!drive.isBusy()) {
                        ...
                        currentState = AutoBlueFront.State.TRAJECTORY_2C;
                    }
                    break;
                ...
                case TRAJECTORY_3:
                    ...
                    if (!drive.isBusy()) {
                        ...
                        currentState = AutoBlueFront.State.TRAJECTORY_3C;
                    }
                    break;
                ...
                case TRAJECTORY_1C:
                    ...
                    if (!drive.isBusy()) {
                        ...
                        currentState = AutoBlueFront.State.SLIDE_UP;
                    }
                    break;
                ...
                case SLIDE_UP:
                    if (!drive.isBusy()) {
                        extend = true;
                        currentState = AutoBlueFront.State.SWERVE_BACK;
                    }
                    break;
                ...
                case SWERVE_BACK:
                    ...
                    if (!drive.isBusy()) {
                        ...
                        if (!leftSlide.isBusy() || !rightSlide.isBusy()) {
                            ...
                            currentState = AutoBlueFront.State.LOWER;
                        }
                    }
                    break;
                ...
                case LOWER:
                    ...
                    drive.followTrajectorySequence(wait);
                    miniExtend = true;
                    currentState = AutoBlueFront.State.BOX_OPEN;
                ...
                case BOX_OPEN:
                    if (!leftSlide.isBusy() || !rightSlide.isBusy()) {
                        ...
                        currentState = AutoBlueFront.State.UPPER;
                    }
                ...
                case UPPER:
                    ...
                    drive.followTrajectorySequence(wait);
                    miniExtend = false;
                    currentState = AutoBlueFront.State.SWERVE_FORWARD;
                ...
                case SWERVE_FORWARD:
                    if (!leftSlide.isBusy() || !rightSlide.isBusy()) {
                        ...
                        currentState = AutoBlueFront.State.SLIDE_DOWN;
                    }
                ...
                case SLIDE_DOWN:
                    ...
                    drive.followTrajectorySequence(wait);
                    extend = false;
                    currentState = AutoBlueFront.State.IDLE;
                    break;
